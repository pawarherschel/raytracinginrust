...
// IMAGE
pub static ASPECT_RATIO: f32 = 16.0 / 9.0;
...
pub static IMAGE_HEIGHT: u64 = (IMAGE_WIDTH as f32 / ASPECT_RATIO) as u64;
...
// CAMERA
pub static VIEWPORT_HEIGHT: f32 = 2.0;
pub static VIEWPORT_WIDTH: f32 = VIEWPORT_HEIGHT * ASPECT_RATIO;
pub static FOCAL_LENGTH: f32 = 1.0;
...
// CONSTANTS
pub static NEAR_ZERO_EPSILON: f32 = 1.0e-8;
